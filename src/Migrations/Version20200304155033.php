 ...
 */
final class Version20200304155033 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contracted_disease (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, disease_id INTEGER NOT NULL, people_id INTEGER DEFAULT NULL, contracted_at DATETIME NOT NULL, CONSTRAINT FK_AB91DAB4D8355341 FOREIGN KEY (disease_id) REFERENCES disease (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_AB91DAB43147C936 FOREIGN KEY (people_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
